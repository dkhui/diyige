...
namespace X.App.Com.Wx
{
    ...
    public class Open
    {
        private string ticket_file = HttpContext.Current.Server.MapPath("/dat/wxmp.x");
        /// <summary>
        /// 微信推送Key
        /// </summary>
        private string verify_ticket
        {
            get
            {
        ...
        public string appid = "wx98d80a62d8ca2719";
        private string appsecret = "c456018db89f1edcbe5f76d5bc4ff76b";
        ...
        public void SetVerify_Ticket(string verify_ticket)
        {
        ...
        /// <returns></returns>
        public string Get_AuthUrl(string tourl)
        {
        ...
        /// </param>
        /// <returns></returns>
        public Push Revice(string tk_xml, string sign, string nonce, string timestamp)
        {
            try
            {
        ...
        /// </param>
        /// <returns></returns>
        public MpAuth_Info Get_AuthInfo(string auth_code)
        {
            var dict = new Dictionary<string, string>();
            dict.Add("component_appid", appid);
        ...
        public MpInfo Get_MpInfo(string auth_appid)
        {
            var dict = new Dictionary<string, string>();
            dict.Add("component_appid", appid);
        ...
        /// <returns></returns>
        public MpAuth_Token Get_MpAuth_Token(string auth_appid, string re_token)
        {
            var dict = new Dictionary<string, string>();
            dict.Add("component_appid", appid);
            dict.Add("authorizer_appid", auth_appid);
        ...
        class component_token : Basic.mbase
        {
            public string component_access_token { get; set; }
            public int expires_in { get; set; }
        }
        class create_preauthcode : Basic.mbase
        {
        ...
        /// 公众号授权令牌
        /// </summary>
        public class MpAuth_Token : Basic.mbase
        {
        ...
        /// 公众号信息
        /// </summary>
        public class MpInfo : Basic.mbase
        {
        ...
        /// 公众号授权信息
        /// </summary>
        public class MpAuth_Info : Basic.mbase
        {
            /// <summary>
            /// 授权信息
            /// </summary>
